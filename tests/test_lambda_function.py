...
class TestLambdaHandler:
    def test_lambda_handler_network_success(self, mock_generate_job_id, mock_send_sqs, mock_create_dynamo, mock_persist_s3):
    ...
    def test_lambda_handler_region_success(self, mock_generate_job_id, mock_send_sqs, mock_create_dynamo, mock_persist_s3):
        mock_persist_s3.return_value = "planning-input/planning-test-123.json"
        mock_create_dynamo.return_value = {"status": "PENDING"}
    ...
    def test_lambda_handler_vehicle_success(self, mock_generate_job_id, mock_send_sqs, mock_create_dynamo, mock_persist_s3):
        mock_persist_s3.return_value = "planning-input/planning-test-123.json"
        mock_create_dynamo.return_value = {"status": "PENDING"}
    ...
    def test_lambda_handler_order_success(self, mock_generate_job_id, mock_send_sqs, mock_create_dynamo, mock_persist_s3):
        mock_persist_s3.return_value = "planning-input/planning-test-123.json"
        mock_create_dynamo.return_value = {"status": "PENDING"}
    ...
    def test_lambda_handler_invalid_json(self, mock_generate_job_id, mock_send_sqs, mock_create_dynamo, mock_persist_s3):
    ...
    def test_lambda_handler_validation_error(self, mock_generate_job_id, mock_send_sqs, mock_create_dynamo, mock_persist_s3):
        event = {
            "body": json.dumps({
    ...
    def test_lambda_handler_server_error(self, mock_s3_error, mock_generate_job_id, mock_send_sqs, mock_create_dynamo, mock_persist_s3):
        event = {
            "body": json.dumps({
                "planningType": "network",
                "requestedBy": "test@example.com",
